    ...
    return (
        <>
            <div className="fixed top-[0%] left-[0%] right-[0%] flex-row">
                <div className="two-boxes-container flex justify-center items-center h-100vh bg-fixed bg-linear-" style={{background: 'linear-gradient(to bottom, rgba(255,255,255,0.6),rgba(255,255,255,0.6)),' +
                    ...
                    <div className="box2" style={{
                        width: "40%", height: "60vh", margin: "20px",overflow:"hidden",
                        ...
                        <p style={{fontWeight:'500', color:"#E97A28"}}>Kbank: 198-8-56887-9</p>
                    </div>
                </div>
            </div>
        </>
