...
export default function ProfilePage() {
    ...
    const [pets, setPets] = useState([
        { name: "Jaki", age: "2 Years old", breed: "Jack Russell", image: "/images/cat1.jpg", type: "cat", requests: [] },
        { name: "Maki", age: "2 Years old", breed: "Jack Russell", image: "/images/dog2.jpg", type: "dog", requests: [] },
        { name: "Yoi", age: "2 Years old", breed: "Jack Russell", image: "/images/dog1.jpg", type: "dog", requests: [] },
        { name: "Ichi", age: "2 Years old", breed: "Jack Russell", image: "/images/cat2.jpg", type: "cat", requests: [] },
        { name: "Toji", age: "2 Years old", breed: "Jack Russell", image: "/images/cat2.jpg", type: "cat", requests: [] },
        { name: "Momo", age: "3 Years old", breed: "Poodle", image: "/images/dog2.jpg", type: "dog", requests: [] },
        { name: "Sora", age: "1 Year old", breed: "Persian", image: "/images/cat1.jpg", type: "cat", requests: [] },
        { name: "Kuro", age: "4 Years old", breed: "Labrador", image: "/images/dog1.jpg", type: "dog", requests: [] },
        { name: "Nana", age: "2 Years old", breed: "British Shorthair", image: "/images/cat2.jpg", type: "cat", requests: [] },
        { name: "Choco", age: "3 Years old", breed: "Beagle", image: "/images/dog2.jpg", type: "dog", requests: [] },
    ]);
    ...
    return (
        <>
            <div className="min-h-screen bg-gradient-to-b from-[#F0E7E1] to-[#EAD9C9] flex flex-col">
                <Navbar />
                <h1 className="text-2xl font-bold mt-12 mb-8 text-start pl-4 sm:pl-6 md:pl-8">Your post</h1>
                <EditPetForm trigger={editPopup} setTrigger={setEditPopup} petData={selectedPet} />
