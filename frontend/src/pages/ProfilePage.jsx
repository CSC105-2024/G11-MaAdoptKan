  ...
  return (
      <>
        <div className="min-h-screen bg-gradient-to-b from-[#F0E7E1] to-[#EAD9C9] flex flex-col">
                ...
                >
                  ...
                  <div className="p-4 flex flex-col flex-grow">
                    ...
                    <p className="text-sm flex items-center gap-2 mt-1">
                      <img
                          src={pet.type === "dog" ? "/images/dogorangeicon.png" : "/images/catorangeicon.png"}
                          className="w-6 h-6"
                          alt={pet.type}
                      />
          ...
          {showDeleteConfirm && (
              <div className="fixed inset-0 flex justify-center items-center z-50">
                <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center gap-y-2">
                  <h2 className="text-xl font-bold text-primaryO">Confirm Delete?</h2>
          ...
          <RequestDetailPopup trigger={requestPopup} setTrigger={setRequestPopup} requestData={selectedRequest} />
        </div>
      </>
  );
}